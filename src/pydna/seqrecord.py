...
class SeqRecord(_SeqRecord):
    ...
    def _fix_attributes(self):
        ...
        self.description = _pretty_str(
            defaultkwargs.get(self.description, self.description)
        )
    ...
    def __format__(self, format):
        ...
        if format == "pydnafasta":
            return _pretty_str(
                f">{self.id} {len(self)} bp {self.seguid()}\n{str(self.seq)}\n"
            )
    ...
    def write(self, filename=None, f="gb"):
        ...
        if _os.path.isfile(filename):
            ...
            if self == old:
                ...
                oldmtime = _datetime.fromtimestamp(
                ...
                newmtime = _datetime.fromtimestamp(
                    _os.path.getmtime(filename)
                ).isoformat()
                msg = f"""
